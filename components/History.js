  ...
  return (
    <section className="bg-gray-50 text-black text-center py-[120px] px-5 sm:px-10">
      <div className=" max-w-[1440px] mx-auto">
        <h2 ref={(el) => (historyRef.current[0] = el)} className="text-2xl font-medium text-black">HISTORY OF HERITAGE</h2>
        <p ref={(el) => (historyRef.current[1] = el)} className="mt-4 max-w-2xl mx-auto text-start sm:text-center font-light text-base text-[#808080]">
        ...
        <p ref={(el) => (historyRef.current[2] = el)} className="mt-4 text-start sm:text-center font-light text-base text-[#808080]">
          HWC believes that the endurance of a watch should be coupled with
          aesthetic beauty.
        </p>
        <div ref={(el) => (historyRef.current[3] = el)} className=" w-full flex justify-center">
