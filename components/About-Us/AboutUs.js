...
function AboutUs() {
  ...
  return (
    <>
      <div className="relative min-h-[75vh] md:min-h-[90vh] bg-[url(../public/Images/about_mob_banner.png)]  md:bg-[url(../public/Images/about_banner.png)] bg-cover bg-center  flex items-end md:items-center justify-start pt-20 md:pt-0 px-5 md:px-0 overflow-hidden">
        {/* <Image
